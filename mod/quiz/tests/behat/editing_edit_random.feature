...
Feature: Editing random questions already in a quiz based on category and tags
  ...
  Scenario: Editing tags on one slot does not delete the rest
    ...
    And I set the field "Type or select..." in the "Filter 2" "fieldset" to "easy"
    ...
    And I set the field "Match" in the "Filter 2" "fieldset" to "Any"
    And I set the field "type" in the "Filter 2" "fieldset" to "Tag"
    And I set the field "Type or select..." in the "Filter 2" "fieldset" to "hard"
    And I click on "Apply filters" "button"
    And I select "1" from the "randomcount" singleselect
    And I press "Add random question"
    ...
    And I set the field "Type or select..." in the "Filter 2" "fieldset" to "essay"
    And I click on "Apply filters" "button"
